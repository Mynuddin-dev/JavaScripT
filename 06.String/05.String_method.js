...
var text = "Matha da bal emnei kharap"
...
console.log(text.substring(8, 4))
...
console.log(str.charAt(457))


//str.indexOf(searchValue [, fromIndex])
const paragraph = 'The quick brown fox jumps over the lazy dog. If the dog barked, was it really lazy?'
console.log(`The index of the first "dog" from the beginning is `+paragraph.indexOf("dog"))
console.log(`The index of the first "dog" from the beginning is `+paragraph.indexOf("dog",41))
console.log(`The index of the first "dog" from the beginning is `+paragraph.lastIndexOf("dog"))
